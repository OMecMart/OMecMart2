                ...
                <div class="nav-canvas">
                    <div class="nav-sm nav nav-stacked">
                        ...
                        <li><a class="ajax-link" href="admin"><i
                                    class="glyphicon glyphicon-user"></i><span> Admin </span></a></li>
                        <li><a class="ajax-link" href="user"><i
                                    class="glyphicon glyphicon-user"></i><span> User </span></a></li>
                        <li><a class="ajax-link" href="bengkel"><i
                                    class="glyphicon glyphicon-home"></i><span> Bengkel </span></a></li>
                        <li><a class="ajax-link" href="booking"><i
                                    class="glyphicon glyphicon-pencil"></i><span> Booking </span></a></li>
